...
const SLUG = 'carte-internet'
const TITLE = 'CARTE INTERNET'

export default function CarteInternetPage() {
  ...
  const filtered = useMemo(() => {
    ...
    const map = { genre: 'CARTE INTERNET' } as const
